...
// It uses the xerr.ParseCoder to parse any error into xerr.Coder
// xerr.Coder contains error code, user-safe error message and http status code.
func Send(c *gin.Context, data interface{}, err error) {
	if err != nil {
		xlog.Errorf("%#+v", err)
		coder := xerr.ParseCoder(err)
